...
export class UnderFireMapping extends BaseMapping {

  getName() { return "undrfire"; }
...
// 5: (2) ['P1 Gun X', 'mouseaxis 0']
// 6: (2) ['P1 Gun Y', 'mouseaxis 1']
...
// 12: (2) ['P2 Gun X', 'joyslider 0 0 speed 0x800 center 10']
// 13: (2) ['P2 Gun Y', 'joyslider 0 1 speed 0x800 center 10']
