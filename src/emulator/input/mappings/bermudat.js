...
export class BermudaTriangleMapping extends BaseMapping {

  getName() { return "bermudat"; }
...
// 25: (2) ['Dip A', 'constant 0x3B']
// 26: (2) ['Dip B', 'constant 0x8B']
// 27: (2) ['Dip C', 'constant 0x34']