...
export class TimeSoldiersMapping extends BaseMapping {

  getName() { return "timesold"; }
...
// 24: (2) ['Service Mode', 'switch 0x3C']
// 25: (2) ['Dip A', 'constant 0xDC']
// 26: (2) ['Dip B', 'constant 0xFF']