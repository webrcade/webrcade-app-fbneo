...
export class KrazyBowlMapping extends BaseMapping {

  getName() { return "krzybowl"; }
...
// 9: (2) ['P1 Trackball X', 'slider 0x4000 0x4001 speed 0x800 center 10']
// 10: (2) ['P1 Trackball Y', 'slider 0x4002 0x4003 speed 0x800 center 10']
...
// 20: (2) ['P2 Trackball X', 'joyslider 0 0 speed 0x800 center 10']
// 21: (2) ['P2 Trackball Y', 'joyslider 0 1 speed 0x800 center 10']
// 22: (2) ['Reset', 'switch 0x3D']
// 23: (2) ['Service', 'switch 0x0A']
// 24: (2) ['Dip A', 'constant 0xFF']
// 25: (2) ['Dip B', 'constant 0xFF']
// 26: (2) ['Dip C', 'constant 0xFF']